...
let nativeOnboardingLocaleDefaultsKey = "slackclaw.locale"
let nativeOnboardingDefaultWindowSize = CGSize(width: 1280, height: 860)
let nativeOnboardingMinimumWindowSize = CGSize(width: 960, height: 720)
...
struct NativeOnboardingInstallProgressSnapshot: Sendable {
    var phase: SlackClawDeployPhase?
    var percent: Double?
    var message: String?
}
...
private func nativeOnboardingInstallProgressFallback(_ phase: SlackClawDeployPhase?) -> Double {
    switch phase {
    case .some(.reusing):
        return 34
