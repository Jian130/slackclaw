...
export function WorkspaceScaffold(
  props: PropsWithChildren<HeaderProps & { className?: string }>
) {
  return (
    <section className={`workspace-scaffold panel-stack ${props.className ?? ""}`.trim()}>
...
export function OperationsScaffold(
  ...
  return (
    <section className={`operations-scaffold panel-stack ${props.className ?? ""}`.trim()}>
      <PageHeader title={props.title} subtitle={props.subtitle} actions={props.actions} />
...
export function SplitContentScaffold(
  ...
  return (
    <section className={`split-content-scaffold panel-stack ${props.className ?? ""}`.trim()}>
      <PageHeader title={props.title} subtitle={props.subtitle} actions={props.actions} />
...
export function GuidedFlowScaffold(
  ...
  return (
    <section className={`guided-flow-scaffold ${props.className ?? ""}`.trim()}>
