...
const en: OnboardingCopy = {
  ...
  welcomeHighlights: [
    { title: "One-Click Setup", body: "Start SlackClaw in minutes with no terminal commands or technical configuration." },
...
const zh: OnboardingCopy = {
  ...
  welcomeHighlights: [
    { title: "一键完成设置", body: "无需终端命令或复杂技术配置，几分钟内启动 SlackClaw。" },
...
const ja: OnboardingCopy = {
  ...
  welcomeHighlights: [
    { title: "ワンクリックでセットアップ", body: "ターミナル操作や高度な技術設定なしで、数分で SlackClaw を開始できます。" },
  ...
  employeeBody: "アバター、役割、プリセットスキルを選択します。SlackClaw が実際の OpenClaw エージェント環境を作成します。",
  employeeName: "社員名",
  employeeRole: "役職",
...
const ko: OnboardingCopy = {
  ...
  welcomeHighlights: [
    { title: "원클릭 설정", body: "터미널 명령이나 복잡한 기술 설정 없이 몇 분 안에 SlackClaw를 시작합니다." },
  ...
  employeeBody: "아바타, 역할, 프리셋 스킬을 선택하세요. SlackClaw가 실제 OpenClaw 에이전트 작업 공간을 만듭니다.",
  employeeName: "직원 이름",
  employeeRole: "직무",
...
const es: OnboardingCopy = {
  ...
  welcomeHighlights: [
    { title: "Configuración con un clic", body: "Inicia SlackClaw en minutos sin comandos de terminal ni configuración técnica compleja." },
  ...
  employeeBody: "Elige avatar, rol y habilidades predeterminadas. SlackClaw crea un workspace real de agente OpenClaw detrás de este empleado.",
